...
export const curatedStories: CuratedStory[] = [
  {
    ...
    judgeRules: [
      ...
      { pattern: /藏|躲|同伙|第四个人/, verdict: '否', detail: '站内没有藏着另一个人。' },
  ...
  },
  {
    ...
    suggestedQuestions: ['第四个人真的在车上吗？', '这和轮椅有关吗？', '司机在测试站台吗？'],
    judgeRules: [
      { pattern: /第四.*乘客|第四个人.*车上|监控死角|看不到.*乘客/, verdict: '是', fact: 0, detail: '车上确实还有一名不容易被看见的乘客。' },
      ...
      { pattern: /第四.*不存在|没有第四|司机.*幻觉|看错人/, verdict: '否', detail: '第四名乘客真实存在，并非司机的幻觉。' },
